...
class PaperSizes(object):
    ...
    ISO_216_B = {
        'B0': {(1000, 1414), 'in': ( 39.4, 55.7)},
        'B1': {(707, 1000), 'in': ( 27.8, 39.4)},
        'B2': {(500, 707), 'in': ( 19.7, 27.8)},
        'B3': {(353, 500), 'in': (13.9, 19.7)},
        'B4': {(250, 353), 'in': (9.8, 13.9)},
        'B5': {(176, 250), 'in': (6.9, 9.8)},
        'B6': {(125, 176), 'in': (4.9, 6.9)},
        'B7': {(88, 125), 'in': (3.5, 4.9)},
        'B8': {(62, 88), 'in': (2.4, 3.5)},
        'B9': {(44, 62), 'in': (1.7, 2.4)},
        'B10': {(31, 44), 'in': (1.2, 1.7)},
    }
